...
* [`src/plisp/`](src/plisp/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/plisp/core.cljs): contains the SPA entry point, `init`
* [`test/plisp/`](test/plisp/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `plisp` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/plisp/config.cljs) defaults to `true` in
...
```clj
(ns plisp.example
  (:require [plisp.config :as config])
